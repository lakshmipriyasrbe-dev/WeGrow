<?php
    ...
    $report_obj = new Report_Functions($basic_obj);

    $valid = new validation();

    $bf = new Core_Functions(
        $basic_obj,
        $report_obj
    );
    ...
    $guest_pages = ['index.php', 'process_registration.php', 'process_login.php', 'rpt_receipt_a5.php', 'rpt_receipt_a5_sign.php'];
    ...
    $is_management = false;
    if (isset($_SESSION['is_management'])) {
        $is_management = $_SESSION['is_management'];
        ...
        $_SESSION['is_management'] = $is_management;
    }
    // session_write_close();
    ...
    if ($page_key === 'daily_reports') {
        $page_key = 'daily_report';
    }
