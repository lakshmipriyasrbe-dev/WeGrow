...
$enquiry_id = ""; $name = ""; $mobile_number = ""; $degree_completed = ""; $address = ""; $course_id = ""; $father_spouse_name = ""; $dob = ""; $description = ""; $enquiry_date = "";
...
if (isset($_REQUEST['view_course_enquiry_id'])) {
    ...
    if (!empty($view_course_enquiry_id)) {
        ...
        if (!empty($enquiry_list)) {
            ...
            if (empty($enquiry_date) || $enquiry_date == '0000-00-00') {
            ...
            <div class="form-row">
                ...
                <div class="form-group col-4">
                    ...
                    <input
                        ...
                        name="enquiry_date"
                        class="form-input"
                        value="<?php echo htmlspecialchars($enquiry_date); ?>"
                        required
                    >
                    <span id="error-enquiry_date" class="error-msg"></span>
                </div>
                ...
                <div class="form-group col-4">
                    ...
                    <input
                        ...
                        class="form-input"
                        value="<?php echo htmlspecialchars($father_spouse_name); ?>"
                        onkeypress="return allowLettersOnly(event)"
                    >
                ...
                <div class="form-group col-6">
                    <label>Address *</label>
                    <textarea name="address" class="form-input" rows="3" required><?php echo htmlspecialchars($address); ?></textarea>
                    <span id="error-address" class="error-msg"></span>
                </div>
                <div class="form-group col-6">
                    <label>Description</label>
                    <textarea name="description" class="form-input" rows="3"><?php echo htmlspecialchars($description); ?></textarea>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name']) && !isset($_POST['action'])) {
    $enquiry_id = $bf->sanitize($_POST['enquiry_id'] ?? '');
    $enquiry_date = $bf->sanitize($_POST['enquiry_date'] ?? '');
    ...
    $errors = [];
    $res = $valid->common_validation($enquiry_date, 'Enquiry Date', 'text');
    if ($res) $errors['enquiry_date'] = $res;
        ...
        <div class="table-responsive">
            <table>
                ...
                foreach ($enquiries as $u) { 
                    ...
                    $enquiry_date_disp = !empty($u['enquiry_date']) ? date('d-m-Y', strtotime($u['enquiry_date'])) : '';
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($enquiry_date_disp); ?></td>
                        <td>
