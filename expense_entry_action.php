...
if (isset($_REQUEST['view_expense_entry_id'])) {
    ...
    <script>
        ...
        selectedCategory = '<?php echo $expense_category_id; ?>';
        existingFiles = <?php echo json_encode(!empty($attachments_str) ? array_filter(array_map('trim', explode(',', $attachments_str))) : []); ?>;
        selectedFiles = [];
