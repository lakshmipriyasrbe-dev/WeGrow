...
if (isset($_REQUEST['view_expense_entry_id'])) {
    ...
    <script>
        ...
        var selectedCategory = '<?php echo $expense_category_id; ?>';
        ...
        var selectedFiles = [];
        var existingFiles = <?php echo json_encode(!empty($attachments_str) ? array_filter(array_map('trim', explode(',', $attachments_str))) : []); ?>;
