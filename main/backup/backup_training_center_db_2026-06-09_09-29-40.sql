...
CREATE TABLE `tc_payment` (
  ...
  KEY `idx_student_id` (`student_id`),
  KEY `idx_payment_date` (`payment_date`(768)),
  KEY `idx_deleted` (`deleted`)
...
-- Dump completed on 2026-06-09  9:29:40
