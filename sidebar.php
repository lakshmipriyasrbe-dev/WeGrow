...
<div class="sidebar" id="sidebar">
    ...
    $reports_pages = ['report_enrollment.php', 'report_payroll.php', 'report_payments.php','report_expense.php', 'report_attendance.php', 'report_placement.php', 'report_daily_work.php'];
    ...
    <ul class="nav-links">
        ...
        $menu_structure = [
            ...
            [
                ...
                'pages' => ['report_enrollment', 'report_payroll', 'report_payments','report_expense', 'report_attendance', 'report_placement', 'report_daily_work'],
                'dropdown' => true,
